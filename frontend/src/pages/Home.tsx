    ...
    <div className="h-full w-full flex flex-col">
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
        ...
        <div className="flex items-center gap-2">
          <button className="px-3 py-2 rounded-lg bg-gray-100 text-gray-700 text-sm hover:bg-gray-200" onClick={goBack} disabled={selection.level === "country"}>返回上级</button>
          <button className="px-3 py-2 rounded-lg bg-gray-100 text-gray-700 text-sm hover:bg-gray-200" onClick={setCountry} disabled={selection.level === "country"}>返回中国</button>
        </div>
      </header>
